...
SURE_BIORED_LABEL_TEMPLATES = {
    "Association": ["{subj} is associated with {obj}"],
    "Positive_Correlation": ["{subj} has positive correlation with {obj}"],
    "Negative_Correlation": ["{subj} has negative correlation with {obj}"],
    "Bind": ["{subj} binds to {obj}"],
    "Cotreatment": ["{subj} is used in cotreatment with {obj}"],
    "Comparison": ["{subj} is compared to {obj}"],
    "Drug_Interaction": ["{subj} interacts with drug {obj}"],
    "Conversion": ["{subj} is converted to {obj}"],
}

BIORED_VALID_CONDITIONS_REV = {
    # All relations are valid for all entity type pairs in BIORED
    "ChemicalEntity:ChemicalEntity": BIORED_LABELS,
    "ChemicalEntity:DiseaseOrPhenotypicFeature": BIORED_LABELS,
    "ChemicalEntity:GeneOrGeneProduct": BIORED_LABELS,
    "ChemicalEntity:SequenceVariant": BIORED_LABELS,
    "DiseaseOrPhenotypicFeature:ChemicalEntity": BIORED_LABELS,
    "DiseaseOrPhenotypicFeature:GeneOrGeneProduct": BIORED_LABELS,
    "DiseaseOrPhenotypicFeature:SequenceVariant": BIORED_LABELS,
    "GeneOrGeneProduct:ChemicalEntity": BIORED_LABELS,
    "GeneOrGeneProduct:DiseaseOrPhenotypicFeature": BIORED_LABELS,
    "GeneOrGeneProduct:GeneOrGeneProduct": BIORED_LABELS,
    "SequenceVariant:ChemicalEntity": BIORED_LABELS,
    "SequenceVariant:DiseaseOrPhenotypicFeature": BIORED_LABELS,
    "SequenceVariant:GeneOrGeneProduct": BIORED_LABELS,
    "SequenceVariant:SequenceVariant": BIORED_LABELS,
}

BIORED_LABEL_VERBALIZER = {
