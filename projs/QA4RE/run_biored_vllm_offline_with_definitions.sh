#!/bin/bash
# Run QA4RE with BIORED dataset using vLLM offline (batch processing) with relation definitions
...
echo "Running QA4RE on BIORED dataset with vLLM offline and relation definitions"
echo "Mode: $mode"
echo "Model: $model"
echo "Seed: $seed"
echo ""
...
python qa4re_hf_llm.py \
    ...
    --ex_name multi_choice_qa4re_with_definitions

# Output will be saved to: ../../outputs/BIORED/multi_choice_qa4re_with_definitions/{model}/zero_shot/
