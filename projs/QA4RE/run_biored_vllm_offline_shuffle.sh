#!/bin/bash
# Run QA4RE with BIORED dataset using vLLM offline (batch processing) with shuffled answer choices
...
echo "Running QA4RE on BIORED dataset with vLLM offline and shuffled answer choices"
echo "Mode: $mode"
echo "Model: $model"
echo "Seed: $seed"
echo ""
...
python qa4re_hf_llm.py \
    ...
    --ex_name multi_choice_qa4re_shuffle

# Output will be saved to: ../../outputs/BIORED/multi_choice_qa4re_shuffle/{model}/zero_shot/
