...
def process_arguments(args):
    ...
    if args.dataset == 'TACRED' or args.dataset == 'TACREV':
        ...
        args.LABELS = BIORED_LABELS
        args.LABEL_TEMPLATES = SURE_BIORED_LABEL_TEMPLATES
        args.VALID_CONDITIONS_REV = BIORED_VALID_CONDITIONS_REV
        args.LABEL_VERBALIZER = BIORED_LABEL_VERBALIZER
        args.NOTA_RELATION = None  # BIORED doesn't have a "no relation" class

    # Handle None NOTA_RELATION (for datasets like BIORED without negative class)
    if args.NOTA_RELATION is None:
        args.POS_LABELS = args.LABELS
    else:
